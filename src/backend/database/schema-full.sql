...
CREATE TABLE allowances (
    ...
    calculation_basis VARCHAR(20) DEFAULT 'basic' CHECK (calculation_basis IN ('basic', 'gross')),
    amount DECIMAL(15, 2),
...
CREATE TABLE staff_allowances (
    ...
    custom_allowance_code VARCHAR(100),
    custom_allowance_name VARCHAR(255),
    custom_type VARCHAR(20),
    custom_calculation_basis VARCHAR(20) CHECK (custom_calculation_basis IN ('basic', 'gross')),
    custom_is_taxable BOOLEAN,
    custom_is_pensionable BOOLEAN,
    amount DECIMAL(15, 2),
    percentage DECIMAL(5, 2),
...
CREATE TABLE staff_deductions (
    ...
    custom_deduction_code VARCHAR(100),
    custom_deduction_name VARCHAR(255),
    custom_type VARCHAR(20),
    custom_calculation_basis VARCHAR(20) CHECK (custom_calculation_basis IN ('basic', 'gross')),
    amount DECIMAL(15, 2),
    percentage DECIMAL(5, 2),
...
CREATE TABLE cooperative_members (
    ...
    monthly_contribution DECIMAL(15, 2),
    registration_fee_amount DECIMAL(15, 2) DEFAULT 0,
    registration_fee_paid_at TIMESTAMP WITH TIME ZONE,
    annual_subscription_amount DECIMAL(15, 2) DEFAULT 0,
    first_annual_subscription_paid_at TIMESTAMP WITH TIME ZONE,
    last_annual_subscription_year INTEGER,
