/**
 * Run Audit Trail Fix Migration Script
 * 
 * Run with: node scripts/run-audit-fix.js
 */
...
async function runMigration() {
  try {
    ...
    const migrationPath = path.join(__dirname, '../migrations/027_fix_audit_trail_schema.sql');
    ...
    console.log('\n' + '='.repeat(60));
    log(colors.yellow, '🔄', 'Running Audit Trail Schema Fix...');
    ...
    log(colors.cyan, '📊', 'Audit Trail Columns:');
...
// Run the migration
console.log('\n' + '='.repeat(60));
log(colors.yellow, '🚀', 'Audit Trail Fix Runner');
console.log('='.repeat(60) + '\n');
