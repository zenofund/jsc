...
-- Description: Align notifications table with frontend interface requirements
-- Date: 2024-12-25
-- =====================================================

-- Drop existing notifications table and recreate with full schema
...
COMMENT ON TABLE notifications IS 'System-wide notification management for JSC-PMS';
COMMENT ON COLUMN notifications.recipient_id IS 'User UUID or special value "all" for broadcast notifications';
COMMENT ON COLUMN notifications.recipient_role IS 'Optional role filter for broadcast notifications (admin, hr, cashier, staff)';
COMMENT ON COLUMN notifications.metadata IS 'JSON field for additional contextual data';
